...
my $Speed_Up=$data->{Customer}{Account}{ADSL}{SyncUp};
my $Speed_Down=$data->{Customer}{Account}{ADSL}{SyncDown};

print "OK - Upload Speed is $Speed_Up, Download Speed is $Speed_Down |Speed_Up=$Speed_Up; Speed_Down=$Speed_Down;";
