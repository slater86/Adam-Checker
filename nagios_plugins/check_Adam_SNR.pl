...
my $SNR_Up=$data->{Customer}{Account}{ADSL}{SNRUp};
my $SNR_Down=$data->{Customer}{Account}{ADSL}{SNRDown};

print "OK - Signal to Noise is $SNR_Up Up, $SNR_Down Down |SNR_Up=$SNR_Up; SNR_Down=$SNR_Down;";
